...
namespace collision_detector {
    ...
    inline bool operator==(const Item& lhs, const Item& rhs) {
        return (lhs.position == rhs.position) && (lhs.width == rhs.width);
    }
    ...
    inline bool operator==(const Gatherer& lhs, const Gatherer& rhs) {
        return (lhs.start_pos == rhs.start_pos) && (lhs.end_pos == rhs.end_pos) && (lhs.width == rhs.width);
    }
