...
namespace resource_handler {
	...
	ResourceHandler::ResourceHandler(const char* main_root) {
		...
		// добавл€ем слеш, если его не поставили
	...
	// добавл€ет запись о документе в базовый вектор
	void ResourceHandler::AddItem(ResourceItem&& item) {
		...
		// также обновл€ем записи в словар€х дл€ быстрого поиска
	...
	ResourceType ResourceHandler::ParseFileExtension(std::string_view label) {
		...
		// смотрим совпадение расширени€ файла в константной мапе
